...
<body>
  ...
  ?>
	...
	<form name="f1" action="hospitalLogin.php" method="POST">
		...
		<p>
			<label> Hospital Name: </label><br><br>
			<input type="text" class="input" name="hosp_name" placeholder="Enter Hospital Name" required />
		</p>
		<p>
			<label> Id: </label>
			<br><br>
			<input type="password" class="input" name="hosp_id" placeholder="Enter Hospital ID" required />
		</p>
		<p>
